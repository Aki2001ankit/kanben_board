...
import { groupingParams, orderingParams } from "../utils/miscMap";
...
function DisplayTap() {
  ...
  const [groupParams, setGroupParams] = useState(groupingParams);
  const [orderParams, setOrderParams] = useState(orderingParams);
  ...
  const HandleOptionReordering = () => {
    ...
    orderingParams.handleChange = HandleOrderingChange;
    groupingParams.handleChange = HandleGroupingChange;
